...
export const CRUYFF: TacticalTheorist = {
  ...
  boardState: {
    ...
    players: [
      ...
      { id: "rb", label: "2", x: 15, y: 108, team: "home" },
      { id: "cb1", label: "4", x: 38, y: 112, team: "home" },
      { id: "cb2", label: "6", x: 62, y: 112, team: "home" },
      { id: "lb", label: "3", x: 85, y: 108, team: "home" },
      { id: "dm", label: "5", x: 50, y: 92, team: "home" },
      { id: "cm1", label: "8", x: 25, y: 74, team: "home", highlighted: true },
      { id: "cm2", label: "10", x: 72, y: 66, team: "home", highlighted: true },
      { id: "rw", label: "7", x: 12, y: 45, team: "home" },
      { id: "st", label: "9", x: 50, y: 40, team: "home" },
      { id: "lw", label: "11", x: 88, y: 45, team: "home" },
      { id: "rmk", label: "R", x: 40, y: 60, team: "away" },
    ],
    zones: [
      { x: 16, y: 62, width: 20, height: 22, label: "Carril interior izq.", variant: "positive" },
      { x: 62, y: 54, width: 20, height: 22, label: "Carril interior der.", variant: "positive" },
    ],
  },
};